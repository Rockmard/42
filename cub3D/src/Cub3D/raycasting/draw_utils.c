...
/*   Updated: 2024/12/18 15:39:27 by nrontey          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/cub3D.h"

int	is_border_pixel(int i, int j, int size_modifier, int border_size)
{
	return (i < border_size || i >= size_modifier - border_size || \
